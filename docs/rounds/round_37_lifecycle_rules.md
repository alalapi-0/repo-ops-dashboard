...
> 架构路线映射：`docs/roadmap_40_rounds.md` 中的 Architecture Round 14。

## 目标

实现 idea/bootstrap/active/blocked/maintenance/frozen/archived/abandoned。
...
- 本轮新增或更新的治理资产
- `reports/round_37_completion_report.md`
